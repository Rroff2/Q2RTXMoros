...
// JUMP
//
void infantry_jump_up(edict_t *self)
{
	vec3_t	forward;
...
void InfantryMachineGun(edict_t *self)
{
	...
	// This is a bad idea
	// eject_brass(self, start, right, 1);
}
...
void SP_monster_infantry(edict_t *self)
{
	...
	self->monsterinfo.jumpmove = infantry_jump;

	self->monsterinfo.attack_range = 800;

	self->descname = "Enforcer";
