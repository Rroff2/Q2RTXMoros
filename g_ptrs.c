...
extern int healbot_move_stand;
extern int healbot_move_walk;
extern int healbot_move_run;
extern int healbot_move_search;
extern int healbot_move_attack;
...
extern int medic_move_attackCable2;
...
extern int parasite_move_grapple;
extern int parasite_move_grapple2;
...
extern int soldier_move_attack7;
...
extern void pturret_die(void);
extern void barrel_delay(void);
extern void Trip_Die(void);
extern void Explobox_delay(void);
...
extern void insane_attack(void);
extern void medic_attack(void);
extern void healbot_attack(void);
...
extern void brain_checkattack(void);
...
extern void healbot_search(void);
...
extern void healbot_stand(void);
...
extern void pturret_think(void);
extern void cpoint_think(void);
extern void cpoint_goal_think(void);
extern void cpoint_casualty_think(void);
extern void grenade_think(void);
extern void Support_Think(void);
extern void AmmoStation_Think(void);
extern void Explobox_Think(void);
extern void Head_Think(void);
extern void Trip_Think(void);
extern void drop_flare_think(void);
...
extern void LockdownRespawn(void);
...
extern void SP_worldspawn_think(void); // Rroff
extern void spawn_roamer(void); // Rroff
extern void soldier_jump(void); // Rroff
extern void berserk_jump(void);
extern void chick_jump(void);
extern void infantry_jump(void);
extern void mutant_jump2(void);
extern void acid_think(void); // Rroff
extern void acid_touch(void); // Rroff
extern void Rock_Touch(void); // Rroff
extern void Head_Touch(void); // Rroff
extern void dropflare_playeruse(void); // Rroff
extern void misc_deadsoldier_playeruse(void); // Rroff
extern void insane_playeruse(void); // Rroff
extern void pturret_playeruse(void); // Rroff
extern void cpoint_playeruse(void); // Rroff


// Rroff added all grunt stuff here for simplicity
// need to automate this really
// ===============================================
...
extern int grunt_move_jump;
extern int grunt_move_turn;
extern int grunt_move_flipoff;
extern int grunt_move_taunt;
extern int grunt_move_salute;
...
extern void grunt_playeruse(void);
extern void grunt_search(void);
extern void grunt_jump(void);
// ===============================================
...
{ P_playeruse, dropflare_playeruse },
{ P_playeruse, misc_deadsoldier_playeruse },
{ P_playeruse, pturret_playeruse },
{ P_playeruse, insane_playeruse },
{ P_playeruse, grunt_playeruse },
{ P_playeruse, cpoint_playeruse },
{ P_die, grunt_die },
{ P_die, Trip_Die },
{ P_die, actor_die },
{ P_die, pturret_die },
{ P_die, barrel_delay },
{ P_die, Explobox_delay },
{ P_die, berserk_die },
{ P_die, body_die },
{ P_die, boss2_die },
{ P_die, brain_die },
...
{ P_monsterinfo_attack, healbot_attack },
...
{ P_monsterinfo_attack, insane_attack },
...
{ P_monsterinfo_checkattack, brain_checkattack },
...
{ P_monsterinfo_currentmove, &grunt_move_jump },
{ P_monsterinfo_currentmove, &grunt_move_turn },
{ P_monsterinfo_currentmove, &grunt_move_flipoff },
{ P_monsterinfo_currentmove, &grunt_move_taunt },
{ P_monsterinfo_currentmove, &grunt_move_salute },
...
{ P_monsterinfo_currentmove, &berserk_move_fall },
...
{ P_monsterinfo_currentmove, &chick_move_jump },
...
{ P_monsterinfo_currentmove, &healbot_move_attack },
{ P_monsterinfo_currentmove, &healbot_move_stand },
{ P_monsterinfo_currentmove, &healbot_move_run },
{ P_monsterinfo_currentmove, &healbot_move_walk },
...
{ P_monsterinfo_currentmove, &medic_move_attackCable2 },
...
{ P_monsterinfo_currentmove, &medic_move_spawn },
...
{ P_monsterinfo_currentmove, &mutant_move_attack2 },
{ P_monsterinfo_currentmove, &mutant_move_attack3 },
...
{ P_monsterinfo_currentmove, &mutant_move_jump2 },
...
{ P_monsterinfo_currentmove, &parasite_move_grapple },
{ P_monsterinfo_currentmove, &parasite_move_grapple2 },
...
{ P_monsterinfo_currentmove, &soldier_move_attack7 },
...
{ P_monsterinfo_currentmove, &soldier_move_jump },
...
{ P_monsterinfo_currentmove, &soldier_move_runt },
...
{ P_monsterinfo_currentmove, &tank_move_bonus },
...
{ P_monsterinfo_idle, healbot_idle },
...
{ P_monsterinfo_melee, insane_melee },
...
{ P_monsterinfo_search, healbot_search },
...
{ P_monsterinfo_stand, healbot_stand },
...
{ P_monsterinfo_walk, healbot_walk },
...
{ P_monsterinfo_jumpmove, soldier_jump }, // Rroff
{ P_monsterinfo_jumpmove, berserk_jump }, // Rroff
{ P_monsterinfo_jumpmove, chick_jump }, // Rroff
{ P_monsterinfo_jumpmove, infantry_jump }, // Rroff
{ P_monsterinfo_jumpmove, mutant_jump2 }, // Rroff
{ P_monsterinfo_jumpmove, grunt_jump },
{ P_pain, grunt_pain },
{ P_pain, actor_pain },
{ P_pain, berserk_pain },
{ P_pain, boss2_pain },
...
{ P_think, bfg_explode },
{ P_think, bfg_think },
{ P_think, pturret_think },
{ P_think, cpoint_think },
{ P_think, cpoint_goal_think },
{ P_think, cpoint_casualty_think },
{ P_think, Head_Think },
{ P_think, grenade_think },
{ P_think, Support_Think },
{ P_think, AmmoStation_Think },
{ P_think, Explobox_Think },
{ P_think, Trip_Think },
{ P_think, drop_flare_think },
{ P_think, BossExplode },
...
{ P_think, SP_worldspawn_think }, // Rroff
{ P_think, acid_think }, // Rroff
{ P_think, spawn_roamer }, // Rroff
{ P_touch, flare_touch }, // Q2RTX
{ P_touch, event_trigger_touch },
{ P_touch, stim_touch },
{ P_touch, barrel_touch },
{ P_touch, bfg_touch },
{ P_touch, blaster_touch },
{ P_touch, dropflare_touch },
{ P_touch, button_touch },
{ P_touch, door_touch },
{ P_touch, drop_temp_touch },
{ P_touch, func_object_touch },
{ P_touch, gib_touch },
{ P_touch, brass_touch },	// Rroff
{ P_touch, Grenade_Touch },
{ P_touch, acid_touch },	// Rroff
{ P_touch, Rock_Touch },	// Rroff
{ P_touch, Head_Touch },	// Rroff
{ P_touch, hurt_touch },
